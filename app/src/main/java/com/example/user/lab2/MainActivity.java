...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        computerMora=(TextView)findViewById(R.id.computterMora);
        final RadioGroup radioGroup =(RadioGroup) findViewById(R.id.radioGrop);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(gamer.getText().toString().equals(""))
                    ...
                    if((mora_gamer==0&&mora_computer==1)||(mora_gamer==1&&mora_computer==2)||(mora_gamer==2&&mora_computer==1)){
                        winner.setText("電腦");
